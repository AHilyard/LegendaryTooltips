...
public class LegendaryTooltipsConfig
{
	...
	static final List<ConfigValue<List<? extends String>>> itemSelectors = new ArrayList<ConfigValue<List<? extends String>>>(LegendaryTooltips.NUM_FRAMES);
	...
	public LegendaryTooltipsConfig(ForgeConfigSpec.Builder build)
	{
		...
		modelRotationSpeed = build.comment(" The speed at which 3D models in tooltips will rotate.  Lower values rotate faster, set to 0 to disable rotation.").defineInRange("model_rotation_speed", 12.0, 0, 50.0);
